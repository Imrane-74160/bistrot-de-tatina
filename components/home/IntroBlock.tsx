...
export function IntroBlock() {
  ...
  return (
    <section
      id="intro"
      className="relative bg-creme pb-28 pt-16 sm:pt-20 lg:pb-32 lg:pt-24"
    >
      ...
      {/* Badge rond en chevauchement sur la section suivante (décoratif).
          z-30 : au-dessus des sections, mais SOUS le header sticky (z-40). */}
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 z-30 hidden translate-y-1/2 sm:block"
        aria-hidden="true"
      >
        <div className="container-bistrot">

...
export function IntroBlock() {
  ...
  return (
    <section id="intro" className="relative bg-creme pb-28 pt-16 sm:pt-20 lg:pb-32 lg:pt-24">
      {/* Contexte isolé pour le halo (derrière le contenu) — n'enferme PAS le
          badge, qui doit rester au-dessus de la section suivante. */}
      ...
      {/* Badge rond en chevauchement sur la section suivante (décoratif).
          Enfant direct de la section non isolée → passe au-dessus de tout. */}
      <div
        className="pointer-events-none absolute inset-x-0 bottom-0 z-40 hidden translate-y-1/2 sm:block"
        aria-hidden="true"
      >
